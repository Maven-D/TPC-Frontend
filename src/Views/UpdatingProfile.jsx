    ...
    <div className="update-profile">
      <h4>Update Profile</h4>
        ...
        <form>
          ...
          <input type="text" id="update-name" name="name" defaultValue={data['fields']['name']}/>

          <label for="roll-number">Roll Number:</label>
          <input type="text" id="update-roll" name="roll-number" defaultValue={data['pk']}/>

          <label for="profile-picture">Profile Picture:</label>
          <input type="text" id="update-profile-pic" name="profile-picture" defaultValue={data['fields']['studprofilepic']}/>

          <label for="email">Email:</label>
          <input type="email" id="update-email" name="email" defaultValue={data['fields']['email']}/>

          <label for="resume-class-10">Class 10 Marks:</label>
          <input type="number" id="update-c10m" name="resume-class-10" defaultValue={data['fields']['m10']}/>

          <label for="resume-class-11">Class 11 Marks:</label>
          <input type="number" id="update-c11m" name="resume-class-11" defaultValue={data['fields']['m11']}/>

          <label for="resume-class-12">Class 12 Marks:</label>
          <input type="number" id="update-c12m" name="resume-class-12" defaultValue={data['fields']['m12']}/>

          <label for="semester-1">Semester 1 Marks:</label>
          <input type="number" id="update-cs1m" name="semester-1" defaultValue={data['fields']['msem1']}/>

          <label for="semester-2">Semester 2 Marks:</label>
          <input type="number" id="update-cs2m" name="semester-2" defaultValue={data['fields']['msem2']}/>

          <label for="semester-3">Semester 3 Marks:</label>
          <input type="number" id="update-cs3m" name="semester-3" defaultValue={data['fields']['msem3']}/>

          <label for="semester-4">Semester 4 Marks:</label>
          <input type="number" id="update-cs4m" name="semester-4" defaultValue={data['fields']['msem4']}/>

          <label for="semester-5">Semester 5 Marks:</label>
          <input type="number" id="update-cs5m" name="semester-5" defaultValue={data['fields']['msem5']}/>

          <label for="semester-6">Semester 6 Marks:</label>
          <input type="number" id="update-cs6m" name="semester-6" defaultValue={data['fields']['msem6']}/>

          <label for="semester-7">Semester 7 Marks:</label>
          <input type="number" id="update-cs7m" name="semester-7" defaultValue={data['fields']['msem7']}/>

          <label for="semester-8">Semester 8 Marks:</label>
          <input type="number" id="update-cs8m" name="semester-8" defaultValue={data['fields']['msem8']}/>

          <label for="batch">Batch:</label>
          

          <select defaultValue={data['fields']['name']} id="update-batch">
            {batch.map((elem) => <option >{elem}</option>)}
          </select>

          <label for="area-of-interest">Area of Interest:</label>
          <input type="text" id="update-areaofinterest" name="area-of-interest" defaultValue={data['fields']['name']}/>

          <label for="update-password">Update Password:</label>
          <input type="password" id="update-password" name="update-password" defaultValue={data['fields']['name']}/>

          <label for="update-resume">Update Resume:</label>
          <input type="text" id="update-resume" name="update-resume" defaultValue={data['fields']['resume']}/>
